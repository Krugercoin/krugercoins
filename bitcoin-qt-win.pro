TEMPLATE = app
TARGET = krugercoin-qt
macx:TARGET = "KrugerCoin-Qt"
VERSION = 0.2.0.2
...
QMAKE_CXXFLAGS *= -D_FORTIFY_SOURCE=2 -D__NO_SYSTEM_INCLUDES
# for extra security on Windows: enable ASLR and DEP via GCC linker flags
win32:QMAKE_LFLAGS *= -Wl,--dynamicbase -Wl,--nxcompat -D__NO_SYSTEM_INCLUDES
