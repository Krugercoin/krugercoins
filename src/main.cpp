...
// Copyright (c) 2013-2014 Krugercoin Developers
...
static const int64 nTargetTimespan = 0.35 *24 * 60 * 60;	// Krugercoin: 0.25 day
static const int64 nTargetSpacing = 15;						// Krugercoin: 30 sec
...
unsigned int static KimotoGravityWell(const CBlockIndex* pindexLast, const CBlock *pblock, uint64 TargetBlocksSpacingSeconds, uint64 PastBlocksMin, uint64 PastBlocksMax) {
 ...
 {
         static const int64          BlocksTargetSpacing                          = .25 * 60; 
 ...
 {
         int DiffMode = 1;
		 if (pindexLast->nHeight+1 >= 1121080) { DiffMode = 2; }
